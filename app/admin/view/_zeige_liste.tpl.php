    ...
    <table border="1" class="liste_tbl_angebot">
        ...
        foreach ($angebotsAnfragen as $angebotsAnfrage) {
            ...
            <tr>
                ...
                <td class="col_8">
                    <a href="index.php?action=erzeuge_auftrag&id=<?php echo $angebotsAnfrage->getId() ?>">zu Auftrag konvertieren</a><br />
                    <a href="index.php?action=loesche_auftrag&id=<?php echo $angebotsAnfrage->getId() ?>">Löschen</a>
                </td>
            </tr>
        <?php } ?>
    </table>
        ...
        foreach ($auftraegeAktiv as $auftragAktiv) {
            ...
            <tr <?php if (count($gestoppt) > 0) { ?>class="auftragsstop" <?php } ?>>
                ...
                <td class="col_8">
                    ...
                    <a href="index.php?action=finish_auftrag&id=<?php echo $auftragAktiv->getId() ?>">Abschließen</a>
                    <a href="index.php?action=loesche_auftrag&id=<?php echo $auftragAktiv->getId() ?>">Löschen</a>
                </td>
            </tr>
    ...
    <table border="1" class="liste_tbl">
        ...
        foreach ($auftraegeErledigt as $auftrag) {
            ...
            <tr <?php if (count($gestoppt) > 0) { ?>class="auftragsstop" <?php } ?>>
                ...
                <td class="col_8">
                    <a href="index.php?action=aktiviere_auftrag&id=<?php echo $auftrag->getId() ?>">Aktiv?</a>
                    <a href="index.php?action=loesche_auftrag&id=<?php echo $auftrag->getId() ?>">Löschen</a>
                </td>
                <td class="col_10">
                    <?php
