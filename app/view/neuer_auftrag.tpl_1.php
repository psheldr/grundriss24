...
<div id="content_box_bottom">
    <p>
        ...
        <?php echo $_SESSION['hinweis_jobs'] ?>
    </p>
    <div id="form_box_auftrag">
        <form action="auftrag_anlegen" method="post">
            ...
            <input type="checkbox" class="" value="1" id="job_objektinfo" name="info" <?php if($_SESSION['job_request']['info'] == '1') { echo 'checked="checked"'; }?> />
            <label for="job_objektinfo" class="cb_label" class="cb_label_breit">mit Objektinfo: Text, der als Über- oder Unterschrift mit auf die Zeichnung soll.
                ...
                ggfs. in "Bemerkungen" oder mit auf die Vorlage.</label><br />

            <input type="checkbox" class="cb_label" value="1" id="job_raumbezeichnungen" name="bezeichnungen" class="cb_label_breit" <?php if($_SESSION['job_request']['bezeichnungen'] == '1') { echo 'checked="checked"'; }?> />
            <label for="job_raumbezeichnungen" class="cb_label">mit Raumbezeichnungen: auf dem Grundriss vermerkte Bezeichnungen werden auch
                im gestalteten Grundriss eingetragen. (z.B.: Schlafen, Wohnen, Küche)</label><br />

            <input type="checkbox" class="cb_label" value="1" id="job_qm" name="qm" class="cb_label_breit" <?php if($_SESSION['job_request']['qm'] == '1') { echo 'checked="checked"'; }?> />
            ...
            <div style="clear: both;"></div><a name="test"></a>
            <!--<a name="test" href="javascript:$('#file_upload').uploadifyUpload();" id="btn_upload_now"></a><br />-->
            <input type="submit" value="" id="btn_upload_now" name="upload_btn" onclick="javascript:$('#file_upload').uploadifyUpload();" />
